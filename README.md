...
## Project Structure
qa-automation-demo/
├── ai_pipeline_demo.py # Simulates AI state transitions
├── log_checker.py # Validates AI state logs
├── main.py # Core AI state processing logic
├── tests/
│ ├── test_ai_states.py # Tests AI recovery behavior
│ └── test_log_checker.py # Tests invalid log detection
